...
dataset = load_dataset('text', data_files={'train': '../data/raw/human/human_corpus.txt'})
...
training_args = TrainingArguments(
    output_dir="./distilbert-human-finetuned",
...
# Save the model
trainer.save_model("./distilbert-human-finetuned")
tokenizer.save_pretrained("./distilbert-human-finetuned")
